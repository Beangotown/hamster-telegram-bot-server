...
export const onStartCommand = async (msg: TelegramBot.Message): Promise<void> => {
  ...
  await bot.sendPhoto(
    ...
    {
      caption: `Hamster Woods is no longer accessible.\n\nThank you for every hop, every strategy, and every moment you shared with us. Your support made this journey unforgettable.\n\nThe game has now shut down. We are deeply grateful for your companionship in the forest.\n\n— The Hamster Woods Team`,
      reply_markup: {
        inline_keyboard: [
